...
public class JsonToMapStringToTypeUserType implements UserType, ParameterizedType {
  ...
  public JsonToMapStringToTypeUserType() {
  ...
  public void setParameterValues(Properties parameters) {
    ...
    try {
      mappedClass = Map.class
      valueClass = Class.forName(mappedClassName)
      mapType = objectMapper.getTypeFactory().constructMapType(HashMap, String, valueClass)
  ...
  public Object assemble(Serializable cached, Object owner) throws HibernateException {
    try {
      return objectMapper.readValue(cached.toString(), mapType)
    } catch (Exception e) {
